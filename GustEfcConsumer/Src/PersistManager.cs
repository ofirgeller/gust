    ...
    public partial class PersistManager<T> where T : DbContext, new()
    {
        ...
        public static List<EntitySetInfo> GetEntitySetsInfo(T ctx)
        {
            ...
            var typesAndDependencies = entityTypes.OrderBy(et => et.Name)
                .Select(et =>
                {
                    var dependencies = GetTypesEntityDependsOn(et).Select(e => e.Name).ToHashSet();
        ...
        public SaveResult SaveChanges(string saveBundle)
        {
            ...
            var entitiesInfo = entitesJsonArray.Select(e =>
            {
                ...
                var entityState = Enum.Parse<EntityState>(aspect.SelectToken("entityState").ToString());
                ...
                if (entityState == EntityState.Added && autoGeneratedKeyJToken != null)
                {
                    ...
                    var keyGenType = Enum.Parse<AutoGeneratedKeyType>(autoGeneratedKeyJToken.SelectToken("autoGeneratedKeyType").ToString());
                ...
                (i) =>
                  {
                      ...
                      return new KeyMapping { TempValue = keyValue, EntityTypeName = i.EntitySetInfo.JsName };
                  });
            ...
            var deletedKeys = planedForDeletion
                .Select(ei =>
                {
                    ...
                    return new EntityKey { EntityTypeName = JsTypeNameFromType(ei.Type), KeyValue = keyValue };
                })
                .ToList();
