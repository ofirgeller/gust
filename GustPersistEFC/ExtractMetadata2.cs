...
namespace Gust.PersistEFC
{
    ...
    /// </summary>
    public static class MetadataExtractor2
    {
        ...
        public static PropertyMetadata GetPropertyMetadata(IProperty prop)
        {
            ...
            return new PropertyMetadata
            {
                ...
                DataType = isEnum ? "String" : ShortNameFromlongName(prop.ClrType.Name),
            };
        }
        ...
        public static Metadata GetMetadata(DbContext ctx)
        {
            ...
            var resourceEntityTypeMap = typesMetadate
                .ToDictionary(i =>
                {
                    return i.ShortName;
                }, i =>
                {
                    return i.ShortName + ":#" + i.Namespace;
                });
