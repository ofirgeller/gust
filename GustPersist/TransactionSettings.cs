...
namespace Gust.Persist
{
    public class TransactionSettings
    {
        ...
        static TransactionSettings _default = new TransactionSettings();
        ...
        /// Only applicable if <see cref="TransactionType"/> is not <code>None</code>.  The default IsolationLevel is ReadCommitted.
        /// </remarks>
        public System.Data.IsolationLevel IsolationLevelAs => IsolationMap[(int)IsolationLevel];
        ...
        public override bool Equals(object obj)
        {
            ...
            return other.IsolationLevel.Equals(IsolationLevel)
              && other.Timeout.Equals(Timeout)
              && other.TransactionType.Equals(TransactionType);
        }

        public override int GetHashCode()
        {
            return IsolationLevel.GetHashCode() ^ Timeout.GetHashCode() ^ TransactionType.GetHashCode();
        }

        /// <summary>
        /// Maps the System.Transactions.IsolationLevel to System.Data.IsolationLevel
        /// </summary>
        static readonly System.Data.IsolationLevel[] IsolationMap = new System.Data.IsolationLevel[]  {
