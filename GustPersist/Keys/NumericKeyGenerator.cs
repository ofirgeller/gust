...
{
    /// <summary>
    /// I really hope/think we do not need this interface and class. keys should be created by the database per
    /// table ot ser explictly by the client.
    /// </summary>
        ...
        private void AllocateMoreIds(int pCount)
        {
            ...
            try
            {
                ...
                for (var trys = 0; trys <= MaxTrys; trys++)
                {
                    ...
                    var nextId = (long)Convert.ChangeType(tmp, typeof(Int64));
